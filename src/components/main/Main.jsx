            ...
            <div className="main-container">
                ...
                <div className="main-bottom">
                    <div className="searchbox">
                        <input onChange={(e)=>setInput(e.target.value)} value={input} type="text" placeholder="Type your prompt here..." />
                        <div>
                    ...
                    <p className="bottom-info">
                        Gemini may display innacurate info, including about people, so double check anything important.
                    </p>
                </div>
